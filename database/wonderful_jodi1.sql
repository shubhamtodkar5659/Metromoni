...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2886571660ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=admin">`wonderful_jodi`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=user_regiter">`wonderful_jodi`.`user_regiter`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=shortlist">`wonderful_jodi`.`shortlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=table_plan">`wonderful_jodi`.`table_plan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=countries">`wonderful_jodi`.`countries`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=cities">`wonderful_jodi`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=states">`wonderful_jodi`.`states`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=create_plans">`wonderful_jodi`.`create_plans`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=success_story">`wonderful_jodi`.`success_story`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=review">`wonderful_jodi`.`review`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="212d43604e725c40767d74485632617d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `admin` WHERE `admin`.`id` = 8</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="admin">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `admin` WHERE `admin`.`id` = 2</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="admin">
                            <div class="action_content">
