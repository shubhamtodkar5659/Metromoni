...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1309706496ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=admin">`wonderful_jodi`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=requests">`wonderful_jodi`.`requests`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=user_regiter">`wonderful_jodi`.`user_regiter`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=shortlist">`wonderful_jodi`.`shortlist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=success_story">`wonderful_jodi`.`success_story`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=table_plan">`wonderful_jodi`.`table_plan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=create_plans">`wonderful_jodi`.`create_plans`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=countries">`wonderful_jodi`.`countries`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=cities">`wonderful_jodi`.`cities`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wonderful_jodi&table=states">`wonderful_jodi`.`states`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="753a7642235b4c595e2a642d2e402564">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="wonderful_jodi" targettable="requests">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `requests`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="requests">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `requests` WHERE `requests`.`id` = 22</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="requests">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `requests` WHERE `requests`.`id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="requests">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `requests` WHERE `requests`.`id` = 3</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="user_regiter">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_regiter`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="shortlist">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `shortlist`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="user_regiter">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `requests`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="wonderful_jodi" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
