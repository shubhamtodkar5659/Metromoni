                    ...
                    <form action=""
                      ...
                      <div class="form-group">
                        <label class="control-label"
                               for="mobile">Mobile Number/E-mail<span class="required">*</span></label>
                        <input id="mobile"
                               name="username"
                               type="text"
                               placeholder="Login with Mobile or E-mail"
                      ...
                      <div class="form-group top-margin ">
                        ...
                        <div class="top-margin">
                          <a data-toggle="modal"
                             data-target="#enterEmail"
                             style="cursor:pointer; color: #000; 
    font-size: 15px;"> <small>Forgot Password ?</small></a>
                          <a href="signup-couple.php"
                             class="pull-right"
                             style="cursor:pointer;    color: #000; 
    font-size: 15px;"> <small>Don't have an account ?</small></a>
                        </div>
                      </div>
                    </form>
                  </div>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"
                id="exampleModalLongTitle">Varification</h5>
            <button type="button"
                    class="close "
                    data-dismiss="modal"
                    aria-label="Close">
          ...
          <div class="modal-body">
            ...
            <div class="col-md-12">
              <div class="">
                <p class="text-success hide"
                   id="exists"
                   style="padding: 6px 12px; border: 1px solid green">An updated password has been sent to your Email
                  Address. Or A link has been sent to your Email Address, Follow that link to reset your password.</p>
              </div>
            </div>
            <div class="col-md-12">
              <div class="">
                <p class="text-danger hide"
                   id="dsntExist"
                   style="padding: 6px 12px; border: 1px solid red">Please enter Email that is registered with us.</p>
              </div>
            </div>
          </div>
          <div class="modal-footer">
            ...
            <button type="button"
                    id="sendLink"
                    name="sendLink"
                    class="btn btn-warning">Send link</button>
