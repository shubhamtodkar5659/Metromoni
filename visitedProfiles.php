                                    ...
                                    <div class="row profile mb-4  ">
                                        ...
                                        if ($count > 0) {
                                          ?>
                                                ...
                                                <?php
                                                while ($row_v = mysqli_fetch_array($res)) {
                                                  // $liked = $row['liked_p_id'];
                                                  // echo  $liked ;
                                                  // echo " SELECT * FROM `user_regiter` where `id`= '$row_v[profile_viewed]' ";
                                                  $sql = mysqli_query($conn, "SELECT * FROM `user_regiter` where `id`= '$row_v[profile_viewed]'");
                                                                            ...
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="vendor-meta">
                                                                                    ...
                                                                                    <div>
                                                                                        <?php
                                                                                        // echo '<pre>i am here ';
                                                                                        // print_r($row_v['profile_viewed']);die;
                                                                                        $is_interest_shown_q = "SELECT status FROM requests WHERE user_id = '$current_user_id' AND sent_id = '$row_v[profile_viewed]' ";
                                                                                        ...
                                                                                        <?php if ($is_interest_shown == 1): ?>
                                                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#delete_confirm<?php echo $rows['id']; ?>" data-bs-whatever="@delet" class="btn btn-sm col-3 btn-danger mt-3" name="delReq" id="delReq"><i class="fa fa-thumbs-down"></i></button>
                                                                                        <?php elseif ($is_interest_shown == 0): ?>
                                                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#send_confirm<?php echo $rows['id']; ?>" data-bs-whatever="@send" class="btn btn-sm col-3 btn-primary mt-3" name="senReq" id="senReq"> <i class="fa fa-thumbs-up"></i></button>
                                                                                        <?php elseif ($is_interest_shown == 2 || $is_interest_shown == 3): ?>
                                                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#confirmone<?php echo $rows['id']; ?>" data-bs-whatever="@accept" class="btn btn-sm col-3 btn-primary mt-3" name="Req" id="Req"><i class="fa fa-check"></i></button>
                                                                                        <?php else: ?>
                                                                                                <button type="button" data-bs-toggle="modal" data-bs-target="#send_confirm<?php echo $rows['id']; ?>" data-bs-whatever="@send" class="btn btn-sm col-3 btn-primary mt-3" name="senReq" id="senReq"> <i class="fa fa-thumbs-up"></i></button>
                                                                                        <?php endif; ?>
                                                                                            ...
                                                                                            <div class="row" style="line-height: 2;">
                                                                                                <div class="col-md-4">
                                                                                                    <div class="text-center">
                                                                                                        <img class="img-fluid profileimg-vp px-3 px-sm-4 mt-5 mb-4" style="width: 16rem;border-radius: 11%;border: 1px solid #00aeaf;padding: 0 !important;" src="user_image/<?php echo $rows['filename']; ?>" alt="Upload Image">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-4">
