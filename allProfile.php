        ...
        <div class="container">
            <div class="row ">
                ...
                if (isset($_SESSION['id'])) { //if logged in
                  ...
                  //print_r($plan_expiry_date);  echo '<br>'.date('Y-m-d'); 
                  ...
                  if (isset($_GET['filter_search_btn'])) {
                    ...
                    $religion = isset($_GET['religion']) ? $_GET['religion'] : 'Hindu';
                                                                                  ...
                                                                                  <div>
                                                                                      ...
                                                                                      <?php else: ?>
                                                                                                <?php if (in_array($row['id'], $visited_members) || $remaining_profile_visit > 0): ?>
                                                                                                          <!-- <button type="button" data-toggle="modal" data-target="#view_fml_user<?php echo $row['id']; ?>" data-whatever="@view" class="btn btn-sm col-3 btn-secondary mt-3 view_btn" id="view_btn_<?php echo $row['id']; ?>" name="view_user"> -->
                                                                                                          <a href="user_profile.php?user_id=<?php echo $row['id']; ?>" name="ok" id="ok-btn" type="button" class="btn btn-primary">
                  ...
                  if (isset($_GET['profile_type']) && $_GET['profile_type'] == "female_prof") {
                    //echo 'i am here ='.$plan_expiry_date;
                    $currentDate = date("Y-m-d");
                    $status = "";
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                          ...
                                          $search_filter = '';
                                          $religion = isset($_GET['religion']) ? $_GET['religion'] : 'Hindu';
                                          $search_all = (isset($_GET['filter_search_btn'])) ? '?gender=' . $_GET['gender'] . '&religion=' . $religion . '&age_min=' . $_GET['age_min'] . '&age_max=' . $_GET['age_max'] . '&filter_search_btn=filter_search_btn' : '';
