        ...
        <div class="row center">
          <div class="col-md-offset-1 col-md-10 tab-centr finder-block">
            <div class="finder-caption">
              <h1>Welcome to DevyogVivah</h1>
              
              <!--<p>Perfect matrimony site for doctors ,we are here to help you find a<strong> partner </strong>who value-->
              <!--  your career with this&amp; Matrimony site specially made for Doctors. &amp; we are happy to help you ,so-->
              <!--  lets start. </p>-->
              <div>Perfect Matrimony site where we help You to find right <strong> partner </strong> who value Your preferences.</div>
  ...
  <div class="main-container" id="search-by-detail">
    <div class="container ">
      <div class="tabFilter  col-md-12">
        <div class="well-box shadow">   <div class="row">     <div class="selectgender col-md-7">
              ...
              <div class="tab-content bg-white p_tab-content" id="pills-ml-tabContent">
                ...
                <div class="tab-pane fade row" id="pills-ml-medField" role="tabpanel" aria-labelledby="pills-medField-ml-tab">
                  ...
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    $count = mysqli_num_rows($num_row);
                  ?>
                    <a href="tabFilterProfiles.php?coldata=<?php echo $row['prof']; ?>&gender=Male" class="btn btn-default col-md-2 mr20"><?php echo $prof;
                                                                                                                                          echo "(" . $count . ")";  ?></a>
                  <?php } ?>
                </div>
                <div class="tab-pane fade row" id="pills-ml-spec" role="tabpanel" aria-labelledby="pills-spec-ml-tab">
                  ...
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    $count = mysqli_num_rows($num_row);
                  ?>
                    <a href="tabFilterProfiles.php?coldata=<?php echo $row['specialization']; ?>&gender=Male" class="btn btn-default col-md-2 mr20"><?php echo $row['specialization'];
                                                                                                                                                    echo "(" . $count . ")";  ?></a>
                  <?php }
                  ?>
                </div>
