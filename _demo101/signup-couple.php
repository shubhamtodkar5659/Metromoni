                        ...
                        <form method="post" role="form" action="" class="login-box" enctype="multipart/form-data">
                            <div class="tab-content" id="main_form">
                                ...
                                <ul class="list-inline pull-right">
                                    ...
                                    <li><button type="submit" name="u_register" id="cont1" class="default-btn next-step">Create</button></li>
                                </ul>
                                <div class="clearfix">
...
if (isset($_POST['u_register'])) {
    ...
    $country = ucwords(isset($_POST['country']));
    $state = ucfirst(isset($_POST['state']));
    $city = ucfirst(isset($_POST['city']));
    $address = ucfirst(isset($_POST['address']));
    $marStat = isset($_POST['marStat']);
    $uLang = isset($_POST['lang']);
    $uDiet = isset($_POST['diet']);
    $uHeight = isset($_POST['height']);
    $uReligion = isset($_POST['religion']);
    $uSubCom = ucfirst(isset($_POST['sub-com']));
    if (isset($_POST['community'])) {
        $communityCheckbox = isset($_POST['community']);
    } else {
        $communityCheckbox = "";
    }
    $HEduSearch = isset($_POST['HEduSearch']);
    $uCollage = ucwords(isset($_POST['collage']));
    $profile_for = isset($_POST['profile_for']);
    $uProfession = isset($_POST['Prof']);
    $uSpecialization = isset($_POST['Specialization']);
    $uIncome = isset($_POST['income']);
    $uLiveWithFamily = isset($_POST['yes/no']);
    $uBloodGrp = isset($_POST['bGrp']);
    $uBdate = isset($_POST['bDate']);
    $uAge = isset($_POST['age']);
    $uGender = isset($_POST['gender']);
    $uBtime = isset($_POST['bTime']);
    $uBlocation = isset($_POST['bLocation']);
    $uBio = ucfirst(isset($_POST['bio']));
