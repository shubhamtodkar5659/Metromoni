                                                    ...
                                                    <div class="tabordion">
                                                            ...
                                                            <article>
                                                                <div class="row">
                                                                    <div class="col-xs-12 col-md-6 col-sm-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            Enter something about your-self
                                                        ...
                                                        <section id="section3">
                                                            ...
                                                            <article>
                                                                ...
                                                                <input class="form-control" onkeypress="return float_validation(event, this.value)" type="text" id="height" name="height" value="<?php echo $weight; ?>">
                                                            </div> -->
                                                                        <div class="form-group">
                                                                            Blood Group
                                                        ...
                                                        <section id="section4">
                                                            ...
                                                            <label for="option4">Educational Details</label>
                                                            <article>
                                                                <div class="row">
                                                                    <div class="col-xs-12 col-md-6 col-sm-6">
                                                                        <div class="form-group">
                                                        ...
                                                        <section id="section8">
                                                            ...
                                                            <label for="option8">Siblings Details</label>
                                                            <article>
                                                                <div class="row">
                                                                    <div class="col-xs-12 col-md-6 col-sm-6">
                                                                        <div class="form-group">
