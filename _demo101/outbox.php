...
?>
    ...
    if (isset($_POST['accpt_btn'])) {
        ...
        $rid = $_POST['r_id'];
        // $send_id = $_POST['send_id'];
        $accpt =  mysqli_query($conn, "UPDATE `requests` SET `status` = 2 WHERE  `id`= '$rid' ");
    } else if (isset($_POST['rjct_btn'])) {
        $usrid = $_POST['usr_id'];
        $rid = $_POST['r_id'];
        // $send_id = $_POST['send_id'];
        $rjct =  mysqli_query($conn, "UPDATE `requests` SET `status` = 3 WHERE `id`= '$rid'");
    }
    ?>
    <!DOCTYPE html>
    <html lang="en">
                        ...
                        <div class="row ">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold coral-green text-center">Outbox</h6>
                                </div>
                                <div class="card-body">
                                    <nav>
                                            ...
                                            <div class="tab-pane fade show active" id="pills-recieved" role="tabpanel" aria-labelledby="pills-recieved-tab">
                                                ...
                                                <div class="card-body ">
                                                    <div class="row profile mb-4">
                                                        <?php
                                                        $sent_query = "SELECT liked.id AS id, liked.name AS name, liked.plan_expiry_date, liked.label, liked.specialization, 
                                                                                liked.age, liked.religion, cities.name AS city_name, states.name AS state_name,
                                                                                liked.filename, liked.email, liked.phone, countries.name AS country_name, liked.address,
                                                                                liked.marStat, liked.lang, liked.HighEdu, liked.collage, liked.prof, liked.bDate, liked.bGrp
                                                                                , liked.bTime , liked.income, liked.`sub-com`, liked.height, liked.diet, liked.type_plan 
                                                                            FROM `requests` AS req  
                                                                            LEFT JOIN user_regiter AS liked ON liked.id = req.sent_id AND liked.status = 1
                                                                            LEFT JOIN cities ON cities.id = liked.city AND cities.is_active = 1
                                                                            LEFT JOIN states ON states.id = liked.state AND states.is_active = 1
                                                                            LEFT JOIN countries ON countries.id = liked.country AND countries.is_active = 1 
                                                                            WHERE req.`user_id` = '$current_user_id' AND req.status = 1
                                                                            ";
                                                        $sent_requests = $db->query($sent_query);
                                                        $sent_requests_rows = ($sent_requests['success'] == 1 && !empty($sent_requests['rows'])) ? $sent_requests['rows'] : array();
                                                        ?>
                                                        <?php foreach ($sent_requests_rows as $in_data) : ?>
                                                            <?php
                                                            $currentDate  = date("Y-m-d");
                                                            $plan_expiry_date = $in_data['plan_expiry_date'];
                                                            ?>
                                                            <?php if ($plan_expiry_date > $currentDate) : ?>
                                                                <div class="col-md-2  col-lg-2  mt-4 surface ">
                                                                        ...
                                                                        <div class="card-body vendor-detail">
                                                                            ...
                                                                            <div class="caption">
                                                                                ...
                                                                                <div class="vendor-meta"><span class="location">
                                                                                    ...
                                                                                    <div>
                                                                                        <?php
                                                                                        $is_interest_shown_q = "SELECT status FROM requests WHERE user_id = '$current_user_id' AND sent_id = '$in_data[id]'  ";
                                                ...
                                                <div class="card-body">
                                                    <div class="row profile mb-4">
                                                        ...
                                                        $sent_query = "SELECT liked.id AS id, liked.name AS name, liked.plan_expiry_date, liked.label, liked.specialization, 
                                                                            ...
                                                                            LEFT JOIN states ON states.id = liked.state AND states.is_active = 1
                                                                            LEFT JOIN countries ON countries.id = liked.country AND countries.is_active = 1 
                                                                            WHERE req.`user_id` = '$current_user_id' AND req.status = 2
                                                                            ";
                                                        $sent_requests = $db->query($sent_query);
                                                        $sent_requests_rows = ($sent_requests['success'] == 1) ? $sent_requests['rows'] : array();
                                                        ?>
                                                        <?php foreach ($sent_requests_rows as $in_data) : ?>
                                                            <?php
                                                            $currentDate  = date("Y-m-d");
                                            ...
                                            <div class="tab-pane fade show " id="pills-likes" role="tabpanel" aria-labelledby="pills-likes-tab">
                                                ...
                                                <div class="card-body">
                                                    <div class="row profile mb-4">
                                                        <!-- ================================================================================================================= -->
                                                        <?php
                                                        $liked_query = "SELECT liked.id AS id, liked.name AS name, liked.plan_expiry_date, liked.label, liked.specialization, 
                                                                                    liked.age, liked.religion, cities.name AS city_name, states.name AS state_name,
                                                                                    liked.filename, liked.email, liked.phone, countries.name AS country_name, liked.address,
                                                                                    liked.marStat, liked.lang, liked.HighEdu, liked.collage, liked.prof, liked.bDate, liked.bGrp
                                                                                    , liked.bTime , liked.income, liked.`sub-com`, liked.height, liked.diet, liked.type_plan
                                                                                ...
                                                                                WHERE sl.`user_id`= '$current_user_id' AND sl.`status` = 1
                                                                                ";
                                            ...
                                            <div class="tab-pane fade show " id="pills-deleted" role="tabpanel" aria-labelledby="pills-deleted-tab">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row  profile mb-4">
                                                        <!-- ================================================================================================================= -->
                                                        <?php
                                                        // your profile rejected by others
                                                        $rejected_query = "SELECT rejected.id AS id, rejected.name AS name, rejected.plan_expiry_date, rejected.label, rejected.specialization, 
                                                            rejected.age, rejected.religion, cities.name AS city_name, states.name AS state_name,
                                                            rejected.filename, rejected.email, rejected.phone, countries.name AS country_name, rejected.address,
                                                            rejected.marStat, rejected.lang, rejected.HighEdu, rejected.collage, rejected.prof, rejected.bDate, rejected.bGrp
                                                            , rejected.bTime , rejected.income, rejected.`sub-com`, rejected.height, rejected.diet, rejected.type_plan
                                                        FROM `requests` AS req  
                                                        LEFT JOIN user_regiter AS liker ON liker.id = req.user_id AND liker.status = 1
                                                        LEFT JOIN user_regiter AS rejected ON rejected.id = req.sent_id AND rejected.status = 1
                                                        LEFT JOIN cities ON cities.id = rejected.city AND cities.is_active = 1
                                                        LEFT JOIN states ON states.id = rejected.state AND states.is_active = 1
                                                        LEFT JOIN countries ON countries.id = rejected.country AND countries.is_active = 1 
                                                        WHERE req.`user_id` = '$current_user_id' AND req.status = 3
                                                        ";
                                                                                ...
                                                                                <div class="vendor-meta"><span class="location">
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <?php if ($is_interest_shown == 3) : ?>
                                                                                            ...
                                                                                            <!-- <button type="button" data-bs-toggle="modal" data-bs-target="#delete_confirmone<?php echo $in_data['id']; ?>" data-bs-whatever="@delete" class="btn btn-sm col-3 btn-primary mt-3" name="Req" id="Req"><i class="fa fa-check"></i></button> -->
                                                                                        <?php else : ?>
                                                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#send_confirmone<?php echo $in_data['id']; ?>" data-bs-whatever="@send" class="btn btn-sm btn-primary mt-3" name="senReq" id="senReq"> <i class="fa fa-thumbs-up"></i></button>
                                                                                        <?php endif; ?>
