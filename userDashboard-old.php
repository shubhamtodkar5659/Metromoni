...
">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div id="occupation_details_accordion">
                                                ...
                                                <div id="occupation_details_div" class="p-3 collapse show" aria-labelledby="occupation_details_heading" data-parent="#occupation_details_accordion">
                                                    ...
                                                    <b class="bold_title">India / Out of India  :</b> <?php echo $row['income']; ?><br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div id="family_details_accordion">
                                                <button class="btn collapsed in" id="family_details" type="button" data-toggle="collapse" data-target="#family_details_div" aria-expanded="false" aria-controls="family_details_div">
                                                    <i class="fa fa-caret-right" aria-hidden="true"></i>
                                                    <b>Family Details</b>
                                                </button>
                                                <div id="family_details_div" class="p-3 collapse show" aria-labelledby="family_details_heading" data-parent="#family_details_accordion">
                                                    ...
                                                    <b class="bold_title">Gotra :</b> <?php //echo $row['gotra'];  ?><br>
                                                    <b class="bold_title">Native :</b> <?php //echo $row['gotra'];  ?><br>
                                                    <b class="bold_title">Caste : Open Text :</b> <?php //echo $row['gotra'];  ?><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div id="paternal_details_accordion">
                                                <button class="btn collapsed in" id="paternal_details" type="button" data-toggle="collapse" data-target="#paternal_details_div" aria-expanded="false" aria-controls="paternal_details_div">
                                                    <i class="fa fa-caret-right" aria-hidden="true"></i>
                                                    <b>Paternal Side</b>
                                                </button>
                                                <div id="paternal_details_div" class="p-3 collapse show" aria-labelledby="paternal_details_heading" data-parent="#paternal_details_accordion">
                                                <b class="bold_title">Fater Name :</b> <?php echo $row['email']; ?><br>
                                                    <b class="bold_title">Fater Occupation :</b> <?php echo $row['email']; ?><br>
                                                    <b class="bold_title">Mother Name :</b> <?php echo $row['phone']; ?><br>
                                                    <b class="bold_title">Mother Occupation :</b> <?php echo $row['address']; ?><br>
                                                    <b class="bold_title">No Of Siblings :</b> <?php echo $row['address']; ?><br>
                                                    <b class="bold_title">Brother :</b> <?php echo $row['address']; ?><br>
                                                    <b class="bold_title">Sister :</b> <?php echo $row['address']; ?><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div id="maternal_details_accordion">
                                                <button class="btn collapsed in" id="maternal_details" type="button" data-toggle="collapse" data-target="#maternal_details_div" aria-expanded="false" aria-controls="maternal_details_div">
                                                    <i class="fa fa-caret-right" aria-hidden="true"></i>
                                                    <b>Maternal Details</b>
                                                </button>
                                                <div id="maternal_details_div" class="p-3 collapse show" aria-labelledby="maternal_details_heading" data-parent="#maternal_details_accordion">
                                                <b class="bold_title">Maternal Grandfather Name :</b> <?php echo $row['email']; ?><br>
                                                    <b class="bold_title">Maternal GrandMother Details :</b> <?php echo $row['email']; ?><br>
                                                    <b class="bold_title">Mother Name :</b> <?php echo $row['phone']; ?><br>
                                                    <b class="bold_title">Mother Occupation :</b> <?php echo $row['address']; ?><br>
                                                    <b class="bold_title">No Of Siblings :</b> <?php echo $row['address']; ?><br>
                                                    <b class="bold_title">Brother :</b> <?php echo $row['address']; ?><br>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div id="partner_pref_accordion">
                                                <button class="btn collapsed in" id="partner_pref" type="button" data-toggle="collapse" data-target="#partner_pref_div" aria-expanded="false" aria-controls="partner_pref_div">
                                                    <i class="fa fa-caret-right" aria-hidden="true"></i>
                                                ...
                                                <div id="partner_pref_div" class="p-3 collapse show" aria-labelledby="partner_pref_heading" data-parent="#partner_pref_accordion">
                                                    ...
                                                    <?php echo (isset($row['community-checkbox']) && isset($row['community-checkbox']) != null ? 'True' : ''); ?>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
