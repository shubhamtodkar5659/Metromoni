                    ...
                    <div class="container-fluid">
                        ...
                        <div class=" vendor-list-block card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary text-center">Shortlist</h6>
                            </div>
                            <div class="card-body surface">
                                <div class="row profile mb-4  ">
                                    <?php
                                    //   echo  "SELECT * FROM `shortlist` WHERE `user_id` = '$sesn_id' AND `status` = 1";
                                    $res = mysqli_query($conn, "SELECT * FROM `shortlist` WHERE `user_id` = '$sesn_id' AND `status` = 1");
                                      $count = mysqli_num_rows($res);
                                    if ($count > 0) {
                                        while ($row = mysqli_fetch_array($res)) {
                                            $liked = $row['liked_p_id']; 
                                            $sql = mysqli_query($conn, "SELECT * FROM `user_regiter` where `id`= '$liked'");
                                    ...
                                    ?>
                                                <div class="col-md-6 col-sm-12   col-lg-3  mt-4 surface">
                                                    <div class="vendor-list-block mb30 shadow card gradient-top">
                                                        ...
                                                        <div class="vendor-img " style="width: 100%;">
                                                            ...
                                                            <!-- <a data-bs-toggle="modal" data-bs-target="#confirm<?php echo $rows['id']; ?>"  class="btn mt-3" name="Req" id="Req"><img src="user_image/<?php echo $rows['filename']; ?>" alt="wedding venue" class="match-img py-0"></a> -->
                                                            <div class="<?php echo $rows['label'] ?>"></div>
                                                            <div class="favourite-bg"><?php echo "<button onclick='like(" . $rows['id'] . ");' class='btn'><i class='fa fa-heart like' style='color:red'></i></button> "; ?></div>
                                                            ...
                                                            <div class="caption">
                                                                ...
                                                                <div class="vendor-meta"><span class="location"> <i class="fa fa-map-marker map-icon"></i>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <?php
                                                                        $is_interest_shown_q = "SELECT status FROM requests WHERE user_id = '$current_user_id' AND sent_id = '$row[liked_p_id]' ";
                                        ...
                                        <div class="text-center">    You have not shortlisted anyone yet</div>
                                    <?php
                                    }
                                    ?>
                                </div>
